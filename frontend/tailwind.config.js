  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        'accent-on-dark': colors.accent['on-dark'],
        'accent-on-light': colors.accent['on-light'],
        'accent-hover-text': colors.accent['hover-text'],
        'accent-muted-bg': colors.accent['muted-bg'],
        'accent-border': colors.accent.border,
        'accent-border-subtle': colors.accent['border-subtle'],
        'accent-glow-light': colors.accent['glow-light'],
