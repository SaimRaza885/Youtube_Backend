      ...
      >
        <div className="relative rounded-[18px] overflow-hidden bg-[var(--color-search-bg)]/80 backdrop-blur-2xl border border-border-default">
          <div className="p-8 md:p-10 relative">
            ...
            {/* Divider */}
            <motion.div {...fadeUp(0.4)} className="mt-8 flex items-center">
            ...
            {/* Social Buttons */}
            <motion.div {...fadeUp(0.45)} className="mt-6 grid grid-cols-2 gap-4">
              <button
                type="button"
            ...
            {/* Register Link */}
            <motion.p {...fadeUp(0.5)} className="mt-8 text-center text-base text-text-primary">
