export const Button = ({ children, variant = 'primary', size = 'md', fullWidth = false, loading = false, disabled = false, onClick, className = '', leftIcon: LeftIcon, rightIcon: RightIcon, ...props }) => {
  ...
  const variants = {
    primary: 'bg-accent hover:bg-accent-hover text-accent-on-dark disabled:opacity-50 disabled:cursor-not-allowed shadow-lg shadow-accent/20 hover:shadow-accent/30',
